            ...
            <Grid item xs={12} sm={10} md={8} lg={6}>
                ...
                >
                    <Box py={2}>
                        ...
                        >
                            Please enter your patient's health care ID and select the preferred date, time, and location
                            for the blood transfusion appointment.
                        </Typography>
                    </Box>
                        ...
                        <form onSubmit={handleClick}>
                            <Grid container spacing={2} sx={{p: 3}}>
                                ...
                                <Grid item xs={12}
                                    ...
                                    <BookingButton type="submit" label="Book Transfusion Appointment"/>
                                </Grid>
